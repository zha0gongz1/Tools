#coding=utf-8
'''
author: c0ny1<https://github.com/c0ny1/upload-fuzz-dic-builder>
update: zha0gongz1<https://github.com/zha0gongz1>
date: 2024-04-16 17:19
description: 生成文件上传fuzz字典
'''
...
def parse_args():
	...
	parser.add_argument('-o','--output',metavar='',dest='output_filename', type=str, default='fileUpload_fuzz_dic.txt', 
						help='Output file')
...
if __name__ == '__main__':
	...
	for i in all_parse_suffix:
		str = '%s.%s' % (upload_file_name,repr(i).strip("'"))
		#print '[+] '+type(str)
		f.write(str)
		f.write('\n')
	# if (middleware == 'apache' or middleware == 'all') and (os == 'win' or os == 'all'):
